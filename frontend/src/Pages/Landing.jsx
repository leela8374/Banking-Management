...
import About2 from '../images/bank-2.jpg';
  ...
  return (
    <div className='landingPage'>
        ...
        <div className="landing-header">
            <span className="landing-header-logo"><img src={logo} alt="" /></span>
            <ul>
        ...
        <div className="landing-body">
            ...
            <div className="landing-hero" id='home'>
                <div className="landing-hero-content">
                    <h1>MS <span style={{color:'greenyellow'}}>Bank</span></h1>
            ...
            <div className="footer">
                <p>All rights reserved - &#169; MS Bank.com</p>
            </div>
